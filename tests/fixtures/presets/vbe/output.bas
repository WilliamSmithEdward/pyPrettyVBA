...
Option Explicit
Private Const TAX_RATE As Double = 0.2
Private mLastTotal    As Currency

Public Function InvoiceTotal(ByVal subtotal As Currency, Optional ByVal discount As Double = 0#) As Currency
...
End Function
Sub PrintInvoice()
Dim t As Currency: t = InvoiceTotal(100@, 0.1)
Let t = t
